...
var Collapse = function (e) {
	var t = "collapse", n = "bs.collapse", i = "." + n, r = e.fn[t], s = {toggle: !0, parent: ""},
		...
		}, o = "show", g = "collapse", h = "collapsing", _ = "collapsed", f = "width", c = "height",
		d = {ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, u = function () {
			function i (t, n) {
				this._isTransitioning = !1, this._element = t, this._config = this._getConfig(n), this._triggerArray = e.makeArray(e('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]'));
				for (var i = e(d.DATA_TOGGLE), r = 0; r < i.length; r++) {
					var s = i[r], a = Util.getSelectorFromElement(s);
			...
			return r.toggle = function () {
				e(this._element).hasClass(o) ? this.hide() : this.show()
			}, r.show = function () {
				var t, r, s = this;
				if (!this._isTransitioning && !e(this._element).hasClass(o) && (this._parent && 0 === (t = e.makeArray(e(this._parent).find(d.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (t = null), !(t && (r = e(t).not(this._selector).data(n)) && r._isTransitioning))) {
					var a = e.Event(l.SHOW);
					if (e(this._element).trigger(a), !a.isDefaultPrevented()) {
						t && (i._jQueryInterface.call(e(t).not(this._selector), "hide"), r || e(t).data(n, null));
						var f = this._getDimension();
						e(this._element).removeClass(g).addClass(h), this._element.style[f] = 0, this._triggerArray.length > 0 && e(this._triggerArray).removeClass(_).attr("aria-expanded", !0), this.setTransitioning(!0);
						var c = function () {
							e(s._element).removeClass(h).addClass(g).addClass(o), s._element.style[f] = "", s.setTransitioning(!1), e(s._element).trigger(l.SHOWN)
						};
						if (Util.supportsTransitionEnd()) {
							var u = "scroll" + (f[0].toUpperCase() + f.slice(1));
							e(this._element).one(Util.TRANSITION_END, c).emulateTransitionEnd(600), this._element.style[f] = this._element[u] + "px"
						} else c()
					}
				}
			}, r.hide = function () {
				var t = this;
				if (!this._isTransitioning && e(this._element).hasClass(o)) {
					var n = e.Event(l.HIDE);
					if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
						var i = this._getDimension();
						if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", Util.reflow(this._element), e(this._element).addClass(h).removeClass(g).removeClass(o), this._triggerArray.length > 0) for (var r = 0; r < this._triggerArray.length; r++) {
							var s = this._triggerArray[r], a = Util.getSelectorFromElement(s);
							if (null !== a) e(a).hasClass(o) || e(s).addClass(_).attr("aria-expanded", !1)
						}
						this.setTransitioning(!0);
						var f = function () {
							t.setTransitioning(!1), e(t._element).removeClass(h).addClass(g).trigger(l.HIDDEN)
						};
						this._element.style[i] = "", Util.supportsTransitionEnd() ? e(this._element).one(Util.TRANSITION_END, f).emulateTransitionEnd(600) : f()
					}
				}
				...
				return (e = _extends({}, s, e)).toggle = Boolean(e.toggle), Util.typeCheckConfig(t, e, a), e
			}, r._getDimension = function () {
				return e(this._element).hasClass(f) ? f : c
			...
			}, r._addAriaAndCollapsedClass = function (t, n) {
				if (t) {
					var i = e(t).hasClass(o);
					n.length > 0 && e(n).toggleClass(_, !i).attr("aria-expanded", i)
				}
				...
				return this.each(function () {
					var r = e(this), a = r.data(n), l = _extends({}, s, r.data(), "object" == typeof t && t);
	...
	return e(document).on(l.CLICK_DATA_API, d.DATA_TOGGLE, function (t) {
		...
		var i = e(this), r = Util.getSelectorFromElement(this);
		e(r).each(function () {
			var t = e(this), r = t.data(n) ? "toggle" : i.data();
			u._jQueryInterface.call(t, r)
		})
...
var Modal = function (t) {
	var e = "modal", i = "bs.modal", n = "." + i, s = t.fn[e], o = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
		a = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, r = {
			HIDE: "hide" + n,
			HIDDEN: "hidden" + n,
			SHOW: "show" + n,
			SHOWN: "shown" + n,
		...
		}, d = "modal-scrollbar-measure", l = "modal-backdrop", h = "modal-open", c = "fade", _ = "show", u = {
			DIALOG: ".modal-dialog",
			...
			function s (e, i) {
				this._config = this._getConfig(i), this._element = e, this._dialog = t(e).find(u.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
			}
			...
			return g.toggle = function (t) {
				...
				if (!this._isTransitioning && !this._isShown) {
					Util.supportsTransitionEnd() && t(this._element).hasClass(c) && (this._isTransitioning = !0);
					var n = t.Event(r.SHOW, {relatedTarget: e});
					t(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), t(document.body).addClass(h), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(r.CLICK_DISMISS, u.DATA_DISMISS, function (t) {
						return i.hide(t)
					}), t(this._dialog).on(r.MOUSEDOWN_DISMISS, function () {
						t(i._element).one(r.MOUSEUP_DISMISS, function (e) {
				...
				if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
					var n = t.Event(r.HIDE);
					if (t(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
						this._isShown = !1;
						var s = Util.supportsTransitionEnd() && t(this._element).hasClass(c);
						s && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(r.FOCUSIN), t(this._element).removeClass(_), t(this._element).off(r.CLICK_DISMISS), t(this._dialog).off(r.MOUSEDOWN_DISMISS), s ? t(this._element).one(Util.TRANSITION_END, function (t) {
							return i._hideModal(t)
						}).emulateTransitionEnd(300) : this._hideModal()
					}
				}
			}, g.dispose = function () {
				t.removeData(this._element, i), t(window, document, this._element, this._backdrop).off(n), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
			}, g.handleUpdate = function () {
				this._adjustDialog()
			}, g._getConfig = function (t) {
				return t = _extends({}, o, t), Util.typeCheckConfig(e, t, a), t
			}, g._showElement = function (e) {
				var i = this, n = Util.supportsTransitionEnd() && t(this._element).hasClass(c);
				this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && Util.reflow(this._element), t(this._element).addClass(_), this._config.focus && this._enforceFocus();
				var s = t.Event(r.SHOWN, {relatedTarget: e}), o = function () {
				...
				this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function () {
					t(document.body).removeClass(h), e._resetAdjustments(), e._resetScrollbar(), t(e._element).trigger(r.HIDDEN)
				})
			}, g._removeBackdrop = function () {
				this._backdrop && (t(this._backdrop).remove(), this._backdrop = null)
			}, g._showBackdrop = function (e) {
				var i = this, n = t(this._element).hasClass(c) ? c : "";
				if (this._isShown && this._config.backdrop) {
					var s = Util.supportsTransitionEnd() && n;
					if (this._backdrop = document.createElement("div"), this._backdrop.className = l, n && t(this._backdrop).addClass(n), t(this._backdrop).appendTo(document.body), t(this._element).on(r.CLICK_DISMISS, function (t) {
							i._ignoreBackdropClick ? i._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === i._config.backdrop ? i._element.focus() : i.hide())
						}), s && Util.reflow(this._backdrop), t(this._backdrop).addClass(_), !e) return;
					if (!s) return void e();
					...
					Util.supportsTransitionEnd() && t(this._element).hasClass(c) ? t(this._backdrop).one(Util.TRANSITION_END, o).emulateTransitionEnd(150) : o()
				} else e && e()
				...
				}), t(u.STICKY_CONTENT + ", " + u.NAVBAR_TOGGLER).each(function (e, i) {
				...
				return this.each(function () {
					var o = t(this).data(i), a = _extends({}, s.Default, t(this).data(), "object" == typeof e && e);
					if (o || (o = new s(this, a), t(this).data(i, o)), "string" == typeof e) {
	...
	return t(document).on(r.CLICK_DATA_API, u.DATA_TOGGLE, function (e) {
		var n, s = this, o = Util.getSelectorFromElement(this);
		o && (n = t(o)[0]);
		var a = t(n).data(i) ? "toggle" : _extends({}, t(n).data(), t(this).data());
		"A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
		var d = t(n).one(r.SHOW, function (e) {
			e.isDefaultPrevented() || d.one(r.HIDDEN, function () {
	...
	var r = {
		TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
			...
			for (var i in n) if (Object.prototype.hasOwnProperty.call(n, i)) {
				var o = n[i], a = e[i],
					u = a && r.isElement(a) ? "element" : (s = a, {}.toString.call(s).match(/\s([a-zA-Z]+)/)[1].toLowerCase());
